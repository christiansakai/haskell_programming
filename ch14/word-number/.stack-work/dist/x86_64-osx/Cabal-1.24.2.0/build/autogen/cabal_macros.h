...
/* package word-number-0.1.0.0 */
#define VERSION_word_number "0.1.0.0"
#define MIN_VERSION_word_number(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "word-number-0.1.0.0-GitYjG9RGWlJuwnRZYv3ca"

#define CURRENT_PACKAGE_KEY "word-number-0.1.0.0-GitYjG9RGWlJuwnRZYv3ca"
